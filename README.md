...
~~wget -P models https://storage.googleapis.com/models-hao/voc-model-labels.txt~~
```bash
python3 run_ssd_live_demo.py mb2-ssd-lite /home/models/models/mb2-ssd-lite-mp-0_686.pth /home/models/models/voc-model-labels.txt /place/of/mp4/file.mp4
```
...
```bash
python3 train_ssd.py --dataset_type open_images --datasets /home/ssd_dir/traffic_light_open_images/ --net mb2-ssd-lite --pretrained_ssd /home/models/models/mb2-ssd-lite-mp-0_686.pth --scheduler cosine --lr 0.01 --t_max 100 --validation_epochs 5 --num_epochs 200 --base_net_lr 0.001  --batch_size 32 --checkpoint_folder /home/ssd_dir/ssd_weights/
```
